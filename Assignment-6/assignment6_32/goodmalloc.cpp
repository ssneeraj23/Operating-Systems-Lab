...
#define MEM_SIZE 250 * 1024 * 1024   //giving 250MB of space
#define PAGE_SIZE 2048             // page size
#define PAGE_TABLE_SIZE 125 * 1024 // total number of pages in memory
...
int initial_pages=no_of_free_pages;
...
void printfootprint()
{
    cout<<initial_pages - no_of_free_pages<<"\n";
}
